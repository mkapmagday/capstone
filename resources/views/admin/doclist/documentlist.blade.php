<x-app-layout>
    ...
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        ...
        <br><br>
        <center>
        <img src="https://i.ibb.co/3hbdGmK/Manual-Document-List.jpg" style="" class = "responsive" >
        </center>
        </h2>
    </x-slot>
                    ...
                    <div class="cnt223">
                        ...
                        <form method="POST" action="{{ route('doclist.store') }}">
                            ...
                            <div>
                                ...
                                <x-text-input id="document_name" class="block mt-1 w-full" type="text" name="document_name" :value="old('name')" required autofocus />
