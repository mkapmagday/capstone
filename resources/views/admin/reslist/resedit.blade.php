...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <br>                <div class="popup">
                    <div class="cnt223">
                        ...
                        <form method="POST" action="{{ route('reslist.update', $resident->id) }}">
                            @csrf
                            @method('put')
                            <!-- Name -->
                            <div>
                                ...
                                <x-text-input id="fname" class="block mt-1 w-full" type="text" name="fname" :value="$resident->fname" required autofocus />
