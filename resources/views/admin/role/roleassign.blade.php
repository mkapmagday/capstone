            ...
            <section class="content">
                ...
                <div class="popup">
                    <div class="cnt223">
                        ...
                        <form class="px-4 py-2 bg-red-500  rounded-md" method="POST" action="{{ route('role.removeRole', [$user->id, $user_role->id]) }}" onsubmit="return confirm('Are you sure?');">
                            @csrf
                            @method('delete')
                        ...
                        <form method="POST" action="{{ route('role.assignRole', $user->id) }}">
                            @csrf
