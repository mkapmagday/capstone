                        ...
                        <div style="padding-top: 0px;">
                            ...
                            <div id="bdate">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->bdate" id="bdate" type="date" name="bdate" />
                                    </td>
                                </tr>
                            </div>
                            <div id="years">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->years" id="years" type="text" name="years" />
                                    </td>
                                </tr>
                            </div>
                            <div id="months">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->months" id="months" type="months" name="months" />
                                    </td>
                                </tr>
                            </div>
                            <div id="municipality">
                            ...
                            <div id="age">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->age" id="age" type="text" name="age" />
                                    </td>
                                </tr>
                            </div>
                            <div id="representative">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->representative" id="representative" type="text" name="representative" />
                                    </td>
                                </tr>
                            </div>
                            <div id="address">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->address" id="address" type="text" name="address" />
                                    </td>
                                </tr>
                            </div>
                            <div id="purpose">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->purpose" id="purpose" type="text" name="purpose" />
                                    </td>
                                </tr>
                            </div>
                            <div id="reason">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->reason" id="reason" type="text" name="reason" />
                                    </td>
                                </tr>
                            </div>
                            <div id="relationship">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <x-text-input :value="$docresupdate->relation" id="relation" type="text" name="relation" />
                                    </td>
                                </tr>
                            </div>
