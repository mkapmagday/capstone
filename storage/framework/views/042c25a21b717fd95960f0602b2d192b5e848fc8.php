        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('residentdocres.index')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('residentdocres.show')); ?>" class="nav-link">
                    <i class="nav-icon fas fa-file"></i>
                        <p>
                            Document Status
                        </p>
...
<script src="<?php echo e(asset('dist/js/pages/dashboard.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\capstone\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>