    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <table>
                    <tr>
            <form action="<?php echo e(route('resident.export')); ?>">
            ...
            <form action="<?php echo e(route('reslist.filter')); ?>">
                <div class="row" style="margin-left:150px; margin-top: 20px;">
                    ...
                    <div class="col">
                        <form action="<?php echo e(route('reslist.index')); ?>">
            ...
            <br>                <div class="popup">
                    <div class="cnt223">
                        ...
                        <form method="POST" action="<?php echo e(route('reslist.store')); ?>">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('post'); ?>
                            <!-- Name -->
                            <div>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'name','value' => __('Full Name')]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'fname','class' => 'block mt-1 w-full','type' => 'text','name' => 'fname','required' => true,'autofocus' => true]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'fname','class' => 'block mt-1 w-full','type' => 'text','name' => 'fname','required' => true,'autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                ...
                <div class="popup1">
                    <div class="cnt2231">
                        ...
                        <form method="POST" action="<?php echo e(route('reslist.upload')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" id="exampleFile" name="file" value="<?php echo e(old('file')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer">
                                ...
                                <a class="open-button" style="background-color: #0047AB; color: white;" href="<?php echo e(route('reslist.index')); ?>">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <?php $__currentLoopData = $residents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($resident->id); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($resident->fname); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($resident->email); ?></td>

                                <td class="px-6 py-4 text-sm">
                                    <a href="<?php echo e(route('reslist.edit',$resident->id)); ?>" class="open-button" style="background-color: #0047AB; color: white;">Edit</a>
                                </td>
                                <td class="px-6 py-4 text-sm">
                                    <button class="open-button delete_button" value=<?php echo e($resident->id); ?> style="background-color: #8B0000; color: white;"  type="submit">Delete</button>
                                </td>
                            </tr>
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        $('.delete_button').click(function(e) {
            ...
            var url =  "<?php echo e(route('reslist.destroy', ":delete_id")); ?>";
...
</script><?php /**PATH C:\xampp\htdocs\capstone\resources\views/admin/reslist/reslist.blade.php ENDPATH**/ ?>