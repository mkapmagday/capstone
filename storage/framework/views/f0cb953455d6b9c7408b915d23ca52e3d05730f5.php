        ...
        <div class="content-wrapper">
            ...
            <br>                <div class="popup">
                    <div class="cnt223">
                        ...
                        <form method="POST" action="<?php echo e(route('doclist.store')); ?>">
                            <?php echo csrf_field(); ?>
                            <!-- Name -->
                            <div>
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'document_name','class' => 'block mt-1 w-full','type' => 'text','name' => 'document_name','value' => old('name'),'required' => true,'autofocus' => true]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'document_name','class' => 'block mt-1 w-full','type' => 'text','name' => 'document_name','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('name')),'required' => true,'autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                            ...
                            <div class="flex items-center justify-end mt-4">
                                <button class="open-button ml-4" style="background-color: #c2fbd7; color: green;">
                                    <?php echo e(__('Add Document Type')); ?>
...
</script><?php /**PATH C:\xampp\htdocs\capstone\resources\views/admin/doclist/documentlist.blade.php ENDPATH**/ ?>