            ...
            <section class="content">
                ...
                <div class="popup">
                    <div class="cnt223">
                        ...
                        <form class="px-4 py-2 bg-red-500  rounded-md" method="POST" action="<?php echo e(route('role.removeRole', [$user->id, $user_role->id])); ?>" onsubmit="return confirm('Are you sure?');">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('delete'); ?>
                            <h1> <button type="submit" class="btn btn-danger"><?php echo e($user_role->name); ?></button></h1>
                        </form>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>

                        <form method="POST" action="<?php echo e(route('role.assignRole', $user->id)); ?>">
                            <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\xampp\htdocs\capstone\resources\views/admin/role/roleassign.blade.php ENDPATH**/ ?>