            ...
            <?php if(Route::has('login')): ?>  
				<ul class="navbar-nav ml-auto" >
					...
					<?php if(Auth::user()->hasrole('admin')): ?>
							<a href="<?php echo e(route('admindashboard.index')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">Admin Dashboard</a>
						<?php else: ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
					<?php endif; ?>
					<?php else: ?>
					...
					<li class="nav-item">
                        <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline" ><img style="height:20px; width: 20px;" src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/000000/external-sign-in-web-flaticons-lineal-color-flat-icons-3.png"/>Log in</a>
					</li>
					<li class="nav-item">
                    <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline"><img style="height:20px; width: 20px;" src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/000000/external-register-nursing-flaticons-flat-flat-icons.png"/>Register</a>
                        <?php endif; ?>
					</li>
					<?php endif; ?>
				</ul>
...
<?php /**PATH C:\xampp\htdocs\capstone\resources\views/welcome.blade.php ENDPATH**/ ?>