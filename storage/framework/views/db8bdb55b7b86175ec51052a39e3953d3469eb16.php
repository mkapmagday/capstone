        ...
        <div class="content-wrapper">
            ...
            <form action="<?php echo e(route('user.filter')); ?>">
                <div class="row" style="margin-left:150px; margin-top: 20px;">
                    <div class="col">
                        <input value="<?php echo e($name); ?>" type="text" class="form-control" name="name" id="name" placeholder="Name" style="margin-top: 15px;">
                    </div>
                    <div class="col">
                        <input value="<?php echo e($email); ?>" type="text" class="form-control" name="email" id="email" placeholder="Email" style="margin-top: 15px;">
                    </div>
...
</script><?php /**PATH C:\xampp\htdocs\capstone\resources\views/admin/user/usersearch.blade.php ENDPATH**/ ?>