...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <br>                <div class="popup">
                    <div class="cnt223">
                        ...
                        <form method="POST" action="<?php echo e(route('reslist.update', $resident->id)); ?>">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'fname','class' => 'block mt-1 w-full','type' => 'text','name' => 'fname','value' => $resident->fname,'required' => true,'autofocus' => true]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'fname','class' => 'block mt-1 w-full','type' => 'text','name' => 'fname','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($resident->fname),'required' => true,'autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
</script><?php /**PATH C:\xampp\htdocs\capstone\resources\views/admin/reslist/resedit.blade.php ENDPATH**/ ?>